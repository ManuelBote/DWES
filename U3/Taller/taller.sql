...
INSERT INTO reparacion(id, coche, fechaHora, tiempo, pagado, usuario, precioH) VALUES (1,1,'2020-08-25 15:01:00',2,1,1,0),
(2,2,'2022-03-25 05:28:00',12,1,1,0),(3,3,'2021-03-10 22:14:00',2,1,1,0),(4,4,'2020-10-07 20:07:00',2,1,1,0),(5,5,'2021-10-10 07:13:00',2,1,1,0),
(6,1,'2020-06-19 02:22:00',2,1,1,0),(7,2,'2020-05-28 22:09:00',2,1,1,0),(8,3,'2022-02-22 05:00:00',2,1,1,0),(9,1,'2021-06-29 22:30:00',2,1,1,0),
(10,2,'2020-08-22 12:12:00',2,1,1,0),(11,3,'2022-06-01 10:30:00',12,0,1,0),(12,4,'2022-05-30 17:00:00',2,0,1,0),(13,5,'2022-05-14 09:00:00',2,0,1,0);
...
create procedure generarFactura(pRep int)
begin
	select "Mano de obra" as 'descripcion', precioH as 'importe', tiempo as 'cantidad', precioH*tiempo as "total"
		from reparacion where id = pRep;

	select descripcion, importe, cantidad, importe*cantidad as 'total' from piezareparacion 
		inner join pieza on pieza=codigo
		where reparacion = pRep;
