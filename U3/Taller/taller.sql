...
create procedure generarFactura(pRep int, out pHoras float, out pPrecioH float) 
begin
	select tiempo, precioH into pHoras, pPrecioH 
		from reparacion where id = pRep;

	select descripcion, importe, cantidad, importe*cantidad from piezareparacion 
